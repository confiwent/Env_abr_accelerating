...
# pythran export get_curr_chunk_quality(int list, int, int, int, int:float[] dict)
...
# pythran export get_last_chunk_quality(int list, int, int, int, int:float[] dict)
...
# pythran export get_download_time_upward(int list, float list, float [:,:], float [:,:], int:int[] dict, int, int, int, float, int)
...
# pythran export get_download_time_downward(int list, float list, float [:,:], float [:,:], int:int[] dict, int, int, int, float, int)
