...
class Environment:
    ...
    def searching_upward(self, start_buffer, last_bit_rate, future_chunk_length, rebuf_p, smooth_p, a_dim):
    ...
    def searching_downward(self, start_buffer, last_bit_rate, future_chunk_length, rebuf_p, smooth_p, a_dim):
        max_reward = -10000000000
        reward_comparison = False
        send_data = 0
        parents_pool = [[0.0,-1,-1,-1,-1, start_buffer, int(last_bit_rate)]]
    ...
    def solving_opt(self, start_buffer, last_bit_rate, future_chunk_length, rebuf_p, smooth_p, a_dim):
        if last_bit_rate < 0.5 * a_dim:
            opt_solution = self.searching_upward(start_buffer, last_bit_rate, future_chunk_length, rebuf_p, smooth_p, a_dim)
        else:
            opt_solution = self.searching_downward(start_buffer, last_bit_rate, future_chunk_length, rebuf_p, smooth_p, a_dim)
        return opt_solution